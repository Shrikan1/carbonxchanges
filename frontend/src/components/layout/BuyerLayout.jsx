    ...
    <div className="flex flex-col h-full bg-white border-r border-gray-200">
      ...
      <div className="px-6 py-6 border-b border-gray-200">
        <Link to="/" className="block">
          <span className="wise-font font-black uppercase tracking-tight text-[#6ee7b7] [text-shadow:1px_1px_0_black,2px_2px_0_black,3px_3px_0_black] text-[22px] leading-none block truncate pb-1">
            CARBONXPLANET
          </span>
          <span className="text-[11px] font-bold uppercase font-mono tracking-widest text-[#059669] mt-1.5 block">
            Buyer Portal
          </span>
        </Link>
      </div>
        ...
        <header className="h-[68px] bg-white border-b border-gray-200 px-6 lg:px-8 flex items-center justify-between shrink-0 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/profile" className="flex items-center gap-3 group">
              <div className="w-9 h-9 rounded-sm bg-[#6ee7b7] border-[2px] border-[#0c0c0c] flex items-center justify-center overflow-hidden transition-all shadow-none group-hover:shadow-[2px_2px_0_0_#0c0c0c] group-hover:-translate-y-px">
                {user?.profilePicture
